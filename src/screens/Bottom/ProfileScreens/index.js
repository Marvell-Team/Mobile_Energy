    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{color:"white", marginLeft: 20,fontSize:18 }}>TPHCM,VietNam </Text>
        </View>
        <View style={styles.row}>
          <Icon name="phone" color="white" size={24}/>
          <Text style={{color:"white", marginLeft: 20,fontSize:18}}>0929447829</Text>
        </View>
        <View style={styles.row}>
          <Icon name="email" color="white" size={24}/>
          <Text style={{color:"white",marginLeft: 20,fontSize:18 }}>hotruongan19992017@gmail.com</Text>
        </View>
      </View>
